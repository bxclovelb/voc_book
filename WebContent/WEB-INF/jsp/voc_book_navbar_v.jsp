...
<div class="navbar navbar-fixed-top">
	<div class="navbar-inner">
		...
		<ul class="nav">
			...
			<li><a id="a_voc_test" href="javascript:void(0);"
				onclick="goToVocTest();">词汇量测试</a></li>
			<li><a id="a_voc_exe" href="javascript:void(0);"
				onclick="goToVocExer();">词汇练习</a></li>
			<li><a>|</a></li>
			<li><select id="select_model"
				style="margin: 5px 0 0 15px; width: 150px">
